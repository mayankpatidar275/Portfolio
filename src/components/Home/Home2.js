      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            I fell in love with programming and enjoy building a variety of projects around it
              <br />
              <br />I am currently working as a software developer at ThinkMetal Pvt. Ltd.
              <br />
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/mayankpatidar275"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/mayank-patidar-b09613202/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
